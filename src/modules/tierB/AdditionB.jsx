...
import { MAX_LEVEL, makeQuestion } from './additionLogic'

export default function AdditionB({ profileId }) {
  const { level, stars, setAnswered, setSize, recordAnswer } = useGameProgress(profileId, 'tierB-addition', {
    maxLevel: MAX_LEVEL,
    targetTimeMs: 15000,
  })
