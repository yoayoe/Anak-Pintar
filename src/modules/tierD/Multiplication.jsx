...
import { MAX_LEVEL, makeQuestion } from './multiplicationLogic'

export default function Multiplication({ profileId }) {
  const { level, stars, setAnswered, setSize, recordAnswer } = useGameProgress(profileId, 'tierD-multiplication', {
    maxLevel: MAX_LEVEL,
    targetTimeMs: 12000,
  })
